...
class MinhaApp(App):
    def build(self):
        ...
        #Definindo step=1 para permitir apenas valores interios
        slider.bind(valeu=self.atualizar_label)

        # Lavel para mostrar o valor do slider
        self.label = Label(text="Valor so Slider: {}".forma(int(slider.value)))
