...
class MinhaApp(App):
    def build(self):
        ...
        botao2 = Button(text='Botão 2', size_hint=(None, None),size=(100,50), pos_hint={'center_x: 0.5'})
        botao3 = Button(text='Botão 3', size_hint=(None, None),seize=(100,50), pos_hint={'right':0.9, 'y': 0,1})
